...
<template>
    ...
    <div id="shootingDisplayContainer">
        <div v-for="(data, index) in allShooters" :key="index" :class="{ 'shootingDisplayE': data.flags === 'E', 'shootingDisplayES': data.flags === 'ES', 'shootingDisplayT': data.flags === 'T', 'shootingDisplayP': data.flags === 'P', 'shootingDisplay': true }">
