...
<template>
    ...
    <div id="shootingDisplayContainer">
        <div v-for="(data, index) in allShooters" :key="index" :class="{ 'shootingDisplayE': data.flags === 'E', 'shootingDisplayES': data.flags === 'ES', 'shootingDisplayP': data.flags === 'P', 'shootingDisplay': true }">
